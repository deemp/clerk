...
Research question: How can Haskel be used to develop we develop in Haskell a user-friendly embedded domain specific language (eDSL) be developed in Haskell for spreadsheet generation?

\section{Chapter overview}
This chapter presents the literature review process and a survey of previous works on eDSL design and functional programming approaches to spreadsheet construction. Section 1.2 lists the research questions, the used search engines, the search queries, the literature selection criteria, and the search results. Section 1.2 compares selected articles and shows some authors’ key approaches to designing their frameworks and assessing their usability.
