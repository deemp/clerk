...
-- | Starting at a given coordinate, convert a list of inputs into row builders and return a result
...
-- | Starting at a given coordinate, place a list of inputs according to a row builder
